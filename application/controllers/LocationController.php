...
use App\Models\Backend-LocationModel;
	...
	function __construct()
  {
	...
	public function index(){
		try{
			...
			$sql = " SELECT COPL_SYS_ID, COPL_COP_SYS_ID, COPL_COMP_CODE, COPL_LOCN_CODE, COPL_ACTIVE_YN, COPL_LANG_CODE, COPL_CR_UID, COPL_CR_DT, COPL_UPD_UID, COPL_UPD_DT FROM SALE_M_CORPORATE_POLICY_LOCN  
			...
			if($query){
				...
				foreach ($query as $key => $value) {
					$name_array = [
						...
						"@user_end_parameter_COPL_SYS_ID"	=>	$value["COPL_SYS_ID"],
						"@user_end_parameter_COPL_COP_SYS_ID"	=>	$value["COPL_COP_SYS_ID"],
						"@user_end_parameter_COPL_COMP_CODE"	=>	$value["COPL_COMP_CODE"],
						"@user_end_parameter_COPL_LOCN_CODE"	=>	$value["COPL_LOCN_CODE"],
						"@user_end_parameter_COPL_ACTIVE_YN"	=>	$value["COPL_ACTIVE_YN"],
						"@user_end_parameter_COPL_LANG_CODE"	=>	$value["COPL_LANG_CODE"],
						"@user_end_parameter_COPL_CR_UID"	=>	$value["COPL_CR_UID"],
						"@user_end_parameter_COPL_CR_DT"	=>	$value["COPL_CR_DT"],
						"@user_end_parameter_COPL_UPD_UID"	=>	$value["COPL_UPD_UID"],
						"@user_end_parameter_COPL_UPD_DT"	=>	$value["COPL_UPD_DT"],
					];
	...
	public function create(){
		try{
			...
			$_P_COPL_COP_SYS_ID = $this->request->getVar("@user_end_parameter_COPL_COSYS_ID");
			$_P_COPL_COMP_CODE = $this->request->getVar("@user_end_parameter_COPL_COMCODE");
			$_P_COPL_LOCN_CODE = $this->request->getVar("@user_end_parameter_COPL_LOCN_CODE");
			$_P_COPL_ACTIVE_YN = $this->request->getVar("@user_end_parameter_COPL_ACTIVE_YN");
			...
			$params = array(
				...
				array("name"=>":P_COPL_COP_SYS_ID", "value"=>$_P_COPL_COP_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_COPL_COMP_CODE", "value"=>$_P_COPL_COMP_CODE, "type"=>SQLT_CHR, "length"=>12),
				array("name"=>":P_COPL_LOCN_CODE", "value"=>$_P_COPL_LOCN_CODE, "type"=>SQLT_CHR, "length"=>12),
				array("name"=>":P_COPL_ACTIVE_YN", "value"=>$_P_COPL_ACTIVE_YN, "type"=>SQLT_CHR, "length"=>1),
			...
			$datatoShow = $this->db->storedProcedure("SPINE_SALE_T","INSERT_SALE_M_CORPORATE_POLICY_LOCN", $params);
	...
	public function new(){
		try{
			...
			$sql = " SELECT COPL_SYS_ID, COPL_COP_SYS_ID, COPL_COMP_CODE, COPL_LOCN_CODE, COPL_ACTIVE_YN, COPL_LANG_CODE, COPL_CR_UID, COPL_CR_DT, COPL_UPD_UID, COPL_UPD_DT FROM SALE_M_CORPORATE_POLICY_LOCN  
							WHERE :CR_DT:  = (SELECT MAX(:CR_DT:) FROM SALE_M_CORPORATE_POLICY_LOCN)";
	...
	public function update($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	foreach ($_exist_data as $key => $value) {
					...
					$_OLD_COPL_SYS_ID	=	$value["COPL_SYS_ID"];
					$_OLD_COPL_COP_SYS_ID	=	$value["COPL_COP_SYS_ID"];
					$_OLD_COPL_COMP_CODE	=	$value["COPL_COMP_CODE"];
					$_OLD_COPL_LOCN_CODE	=	$value["COPL_LOCN_CODE"];
					$_OLD_COPL_ACTIVE_YN	=	$value["COPL_ACTIVE_YN"];
					$_OLD_COPL_LANG_CODE	=	$value["COPL_LANG_CODE"];
					$_OLD_COPL_CR_UID	=	$value["COPL_CR_UID"];
					$_OLD_COPL_CR_DT	=	$value["COPL_CR_DT"];
					$_OLD_COPL_UPD_UID	=	$value["COPL_UPD_UID"];
					$_OLD_COPL_UPD_DT	=	$value["COPL_UPD_DT"];
		  	}
		  }
		  
			$_P_COPL_SYS_ID = $this->request->getVar("@user_end_parameter_COPL_SYS_ID");
			$_P_COPL_COP_SYS_ID = $this->request->getVar("@user_end_parameter_COPL_COSYS_ID");
			$_P_COPL_COMP_CODE = $this->request->getVar("@user_end_parameter_COPL_COMCODE");
			$_P_COPL_LOCN_CODE = $this->request->getVar("@user_end_parameter_COPL_LOCN_CODE");
			$_P_COPL_ACTIVE_YN = $this->request->getVar("@user_end_parameter_COPL_ACTIVE_YN");
			...
			$params = array(
				...
				array("name"=>":P_COPL_SYS_ID", "value"=>$_P_COPL_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_COPL_COP_SYS_ID", "value"=>$_P_COPL_COP_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_COPL_COMP_CODE", "value"=>$_P_COPL_COMP_CODE, "type"=>SQLT_CHR, "length"=>12),
				array("name"=>":P_COPL_LOCN_CODE", "value"=>$_P_COPL_LOCN_CODE, "type"=>SQLT_CHR, "length"=>12),
				array("name"=>":P_COPL_ACTIVE_YN", "value"=>$_P_COPL_ACTIVE_YN, "type"=>SQLT_CHR, "length"=>1),
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SALE_T","UPDATE_SALE_M_CORPORATE_POLICY_LOCN", $params);
	...
	public function delete($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	//$_exist_data = $_fetch_edit["result"];
			...
			$_P_COPL_SYS_ID = $this->request->getVar("passing_parameter");
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SALE_T","DELETE_SALE_M_CORPORATE_POLICY_LOCN", $params);
