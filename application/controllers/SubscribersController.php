...
use App\Models\Backend-SubscribersModel;
	...
	function __construct()
  {
	...
	public function index(){
		try{
			...
			$sql = " SELECT SB_SYS_ID, SB_ST_SYS_ID, SB_EMAIL_ID, SB_ACTIVE_YN, SB_LANG_CODE, SB_CR_UID, SB_CR_DT, SB_UPD_UID, SB_UPD_DT FROM SITE_M_SUBSCRIBERS  
			...
			if($query){
				...
				foreach ($query as $key => $value) {
					$name_array = [
						...
						"@user_end_parameter_SB_SYS_ID"	=>	$value["SB_SYS_ID"],
						"@user_end_parameter_SB_ST_SYS_ID"	=>	$value["SB_ST_SYS_ID"],
						"@user_end_parameter_SB_EMAIL_ID"	=>	$value["SB_EMAIL_ID"],
						"@user_end_parameter_SB_ACTIVE_YN"	=>	$value["SB_ACTIVE_YN"],
						"@user_end_parameter_SB_LANG_CODE"	=>	$value["SB_LANG_CODE"],
						"@user_end_parameter_SB_CR_UID"	=>	$value["SB_CR_UID"],
						"@user_end_parameter_SB_CR_DT"	=>	$value["SB_CR_DT"],
						"@user_end_parameter_SB_UPD_UID"	=>	$value["SB_UPD_UID"],
						"@user_end_parameter_SB_UPD_DT"	=>	$value["SB_UPD_DT"],
					];
	...
	public function create(){
		try{
			...
			$_P_SB_ST_SYS_ID = $this->request->getVar("@user_end_parameter_SB_ST_SYS_ID");
			$_P_SB_EMAIL_ID = $this->request->getVar("@user_end_parameter_SB_EMAIL_ID");
			$_P_SB_ACTIVE_YN = $this->request->getVar("@user_end_parameter_SB_ACTIVE_YN");
			...
			$params = array(
				...
				array("name"=>":P_SB_ST_SYS_ID", "value"=>$_P_SB_ST_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SB_EMAIL_ID", "value"=>$_P_SB_EMAIL_ID, "type"=>SQLT_CHR, "length"=>32),
				array("name"=>":P_SB_ACTIVE_YN", "value"=>$_P_SB_ACTIVE_YN, "type"=>SQLT_CHR, "length"=>1),
			...
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","INSERT_SITE_M_SUBSCRIBERS", $params);
	...
	public function new(){
		try{
			...
			$sql = " SELECT SB_SYS_ID, SB_ST_SYS_ID, SB_EMAIL_ID, SB_ACTIVE_YN, SB_LANG_CODE, SB_CR_UID, SB_CR_DT, SB_UPD_UID, SB_UPD_DT FROM SITE_M_SUBSCRIBERS  
							WHERE :CR_DT:  = (SELECT MAX(:CR_DT:) FROM SITE_M_SUBSCRIBERS)";
	...
	public function update($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	foreach ($_exist_data as $key => $value) {
					...
					$_OLD_SB_SYS_ID	=	$value["SB_SYS_ID"];
					$_OLD_SB_ST_SYS_ID	=	$value["SB_ST_SYS_ID"];
					$_OLD_SB_EMAIL_ID	=	$value["SB_EMAIL_ID"];
					$_OLD_SB_ACTIVE_YN	=	$value["SB_ACTIVE_YN"];
					$_OLD_SB_LANG_CODE	=	$value["SB_LANG_CODE"];
					$_OLD_SB_CR_UID	=	$value["SB_CR_UID"];
					$_OLD_SB_CR_DT	=	$value["SB_CR_DT"];
					$_OLD_SB_UPD_UID	=	$value["SB_UPD_UID"];
					$_OLD_SB_UPD_DT	=	$value["SB_UPD_DT"];
		  	}
		  }
		  
			$_P_SB_SYS_ID = $this->request->getVar("@user_end_parameter_SB_SYS_ID");
			$_P_SB_ST_SYS_ID = $this->request->getVar("@user_end_parameter_SB_ST_SYS_ID");
			$_P_SB_EMAIL_ID = $this->request->getVar("@user_end_parameter_SB_EMAIL_ID");
			$_P_SB_ACTIVE_YN = $this->request->getVar("@user_end_parameter_SB_ACTIVE_YN");
			$_P_LANG_CODE = $this->request->getVar("@user_end_parameter_LANG_CODE");
			...
			$params = array(
				...
				array("name"=>":P_SB_SYS_ID", "value"=>$_P_SB_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SB_ST_SYS_ID", "value"=>$_P_SB_ST_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SB_EMAIL_ID", "value"=>$_P_SB_EMAIL_ID, "type"=>SQLT_CHR, "length"=>32),
				array("name"=>":P_SB_ACTIVE_YN", "value"=>$_P_SB_ACTIVE_YN, "type"=>SQLT_CHR, "length"=>1),
				array("name"=>":P_LANG_CODE", "value"=>$_P_LANG_CODE, "type"=>SQLT_CHR, "length"=>2),
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","UPDATE_SITE_M_SUBSCRIBERS", $params);
	...
	public function delete($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	//$_exist_data = $_fetch_edit["result"];
			...
			$_P_SB_SYS_ID = $this->request->getVar("passing_parameter");
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","DELETE_SITE_M_SUBSCRIBERS", $params);
