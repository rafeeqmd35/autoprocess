...
use App\Models\Backend-UsersiteModel;

class UsersiteController extends ResourceController {
	...
	function __construct()
  {
	...
	public function index(){
		try{
			...
			$sql = " SELECT USST_USER_ID, USST_ST_SYS_ID, USST_FROM_DT, USST_UPTO_DT, USST_LANG_CODE, USST_ACTIVE_YN, USST_CR_UID, USST_CR_DT, USST_UPD_UID, USST_UPD_DT FROM SITE_M_USER_SITE  
			...
			if($query){
				...
				foreach ($query as $key => $value) {
					$name_array = [
						...
						"@user_end_parameter_USST_USER_ID"	=>	$value["USST_USER_ID"],
						"@user_end_parameter_USST_ST_SYS_ID"	=>	$value["USST_ST_SYS_ID"],
						"@user_end_parameter_USST_FROM_DT"	=>	$value["USST_FROM_DT"],
						"@user_end_parameter_USST_UPTO_DT"	=>	$value["USST_UPTO_DT"],
						"@user_end_parameter_USST_LANG_CODE"	=>	$value["USST_LANG_CODE"],
						"@user_end_parameter_USST_ACTIVE_YN"	=>	$value["USST_ACTIVE_YN"],
						"@user_end_parameter_USST_CR_UID"	=>	$value["USST_CR_UID"],
						"@user_end_parameter_USST_CR_DT"	=>	$value["USST_CR_DT"],
						"@user_end_parameter_USST_UPD_UID"	=>	$value["USST_UPD_UID"],
						"@user_end_parameter_USST_UPD_DT"	=>	$value["USST_UPD_DT"],
					];
	...
	public function create(){
		try{
			...
			$_P_USST_USER_ID = $this->request->getVar("@user_end_parameter_USST_USER_ID");
			$_P_USST_ST_SYS_ID = $this->request->getVar("@user_end_parameter_USST_ST_SYS_ID");
			$_P_USST_FROM_DT = $this->request->getVar("@user_end_parameter_USST_FROM_DT");
			$_P_USST_UPTO_DT = $this->request->getVar("@user_end_parameter_USST_UPTO_DT");
			$_P_USST_ACTIVE_YN = $this->request->getVar("@user_end_parameter_USST_ACTIVE_YN");
			...
			$params = array(
				...
				array("name"=>":P_USST_USER_ID", "value"=>$_P_USST_USER_ID, "type"=>SQLT_CHR, "length"=>32),
				array("name"=>":P_USST_ST_SYS_ID", "value"=>$_P_USST_ST_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_USST_FROM_DT", "value"=>$_P_USST_FROM_DT, "type"=>SQLT_CHR, "length"=>300),
				array("name"=>":P_USST_UPTO_DT", "value"=>$_P_USST_UPTO_DT, "type"=>SQLT_CHR, "length"=>300),
				array("name"=>":P_USST_ACTIVE_YN", "value"=>$_P_USST_ACTIVE_YN, "type"=>SQLT_CHR, "length"=>1),
			...
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","INSERT_SITE_M_USER_SITE", $params);
	...
	public function new(){
		try{
			...
			$sql = " SELECT USST_USER_ID, USST_ST_SYS_ID, USST_FROM_DT, USST_UPTO_DT, USST_LANG_CODE, USST_ACTIVE_YN, USST_CR_UID, USST_CR_DT, USST_UPD_UID, USST_UPD_DT FROM SITE_M_USER_SITE  
							WHERE :CR_DT:  = (SELECT MAX(:CR_DT:) FROM SITE_M_USER_SITE)";
	...
	public function update($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	foreach ($_exist_data as $key => $value) {
					...
					$_OLD_USST_USER_ID	=	$value["USST_USER_ID"];
					$_OLD_USST_ST_SYS_ID	=	$value["USST_ST_SYS_ID"];
					$_OLD_USST_FROM_DT	=	$value["USST_FROM_DT"];
					$_OLD_USST_UPTO_DT	=	$value["USST_UPTO_DT"];
					$_OLD_USST_LANG_CODE	=	$value["USST_LANG_CODE"];
					$_OLD_USST_ACTIVE_YN	=	$value["USST_ACTIVE_YN"];
					$_OLD_USST_CR_UID	=	$value["USST_CR_UID"];
					$_OLD_USST_CR_DT	=	$value["USST_CR_DT"];
					$_OLD_USST_UPD_UID	=	$value["USST_UPD_UID"];
					$_OLD_USST_UPD_DT	=	$value["USST_UPD_DT"];
		  	}
		  }
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","UPDATE_SITE_M_USER_SITE", $params);
	...
	public function delete($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	//$_exist_data = $_fetch_edit["result"];
			...
			$_P_USST_USER_ID = $this->request->getVar("passing_parameter");
			$_P_USST_ST_SYS_ID = $this->request->getVar("passing_parameter");
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","DELETE_SITE_M_USER_SITE", $params);
