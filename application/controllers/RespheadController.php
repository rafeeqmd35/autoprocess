...
use App\Models\Backend-RespheadModel;

class RespheadController extends ResourceController {
	...
	function __construct()
  {
	...
	public function index(){
		try{
			...
			$sql = " SELECT RSPH_ST_SYS_ID, RSPH_CODE, RSPH_DESC, RSPH_FROM_DT, RSPH_UPTO_DT, RSPH_ACTIVE_YN, RSPH_LANG_CODE, RSPH_CR_UID, RSPH_CR_DT, RSPH_UPD_UID, RSPH_UPD_DT FROM SITE_M_RESP_HEAD  
			...
			if($query){
				...
				foreach ($query as $key => $value) {
					$name_array = [
						...
						"@user_end_parameter_RSPH_ST_SYS_ID"	=>	$value["RSPH_ST_SYS_ID"],
						"@user_end_parameter_RSPH_CODE"	=>	$value["RSPH_CODE"],
						"@user_end_parameter_RSPH_DESC"	=>	$value["RSPH_DESC"],
						"@user_end_parameter_RSPH_FROM_DT"	=>	$value["RSPH_FROM_DT"],
						"@user_end_parameter_RSPH_UPTO_DT"	=>	$value["RSPH_UPTO_DT"],
						"@user_end_parameter_RSPH_ACTIVE_YN"	=>	$value["RSPH_ACTIVE_YN"],
						"@user_end_parameter_RSPH_LANG_CODE"	=>	$value["RSPH_LANG_CODE"],
						"@user_end_parameter_RSPH_CR_UID"	=>	$value["RSPH_CR_UID"],
						"@user_end_parameter_RSPH_CR_DT"	=>	$value["RSPH_CR_DT"],
						"@user_end_parameter_RSPH_UPD_UID"	=>	$value["RSPH_UPD_UID"],
						"@user_end_parameter_RSPH_UPD_DT"	=>	$value["RSPH_UPD_DT"],
					];
	...
	public function create(){
		try{
			...
			$_P_RSPH_ST_SYS_ID = $this->request->getVar("@user_end_parameter_RSPH_ST_SYS_ID");
			$_P_RSPH_CODE = $this->request->getVar("@user_end_parameter_RSPH_CODE");
			$_P_RSPH_DESC = $this->request->getVar("@user_end_parameter_RSPH_DESC");
			$_P_RSPH_FROM_DT = $this->request->getVar("@user_end_parameter_RSPH_FROM_DT");
			$_P_RSPH_UPTO_DT = $this->request->getVar("@user_end_parameter_RSPH_UPTO_DT");
			$_P_RSPH_ACTIVE_YN = $this->request->getVar("@user_end_parameter_RSPH_ACTIVE_YN");
			...
			$params = array(
				...
				array("name"=>":P_RSPH_ST_SYS_ID", "value"=>$_P_RSPH_ST_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_RSPH_CODE", "value"=>$_P_RSPH_CODE, "type"=>SQLT_CHR, "length"=>12),
				array("name"=>":P_RSPH_DESC", "value"=>$_P_RSPH_DESC, "type"=>SQLT_CHR, "length"=>100),
				array("name"=>":P_RSPH_FROM_DT", "value"=>$_P_RSPH_FROM_DT, "type"=>SQLT_CHR, "length"=>300),
				array("name"=>":P_RSPH_UPTO_DT", "value"=>$_P_RSPH_UPTO_DT, "type"=>SQLT_CHR, "length"=>300),
				array("name"=>":P_RSPH_ACTIVE_YN", "value"=>$_P_RSPH_ACTIVE_YN, "type"=>SQLT_CHR, "length"=>1),
			...
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","INSERT_SITE_M_RESP_HEAD", $params);
	...
	public function new(){
		try{
			...
			$sql = " SELECT RSPH_ST_SYS_ID, RSPH_CODE, RSPH_DESC, RSPH_FROM_DT, RSPH_UPTO_DT, RSPH_ACTIVE_YN, RSPH_LANG_CODE, RSPH_CR_UID, RSPH_CR_DT, RSPH_UPD_UID, RSPH_UPD_DT FROM SITE_M_RESP_HEAD  
							WHERE :CR_DT:  = (SELECT MAX(:CR_DT:) FROM SITE_M_RESP_HEAD)";
	...
	public function update($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	foreach ($_exist_data as $key => $value) {
					...
					$_OLD_RSPH_ST_SYS_ID	=	$value["RSPH_ST_SYS_ID"];
					$_OLD_RSPH_CODE	=	$value["RSPH_CODE"];
					$_OLD_RSPH_DESC	=	$value["RSPH_DESC"];
					$_OLD_RSPH_FROM_DT	=	$value["RSPH_FROM_DT"];
					$_OLD_RSPH_UPTO_DT	=	$value["RSPH_UPTO_DT"];
					$_OLD_RSPH_ACTIVE_YN	=	$value["RSPH_ACTIVE_YN"];
					$_OLD_RSPH_LANG_CODE	=	$value["RSPH_LANG_CODE"];
					$_OLD_RSPH_CR_UID	=	$value["RSPH_CR_UID"];
					$_OLD_RSPH_CR_DT	=	$value["RSPH_CR_DT"];
					$_OLD_RSPH_UPD_UID	=	$value["RSPH_UPD_UID"];
					$_OLD_RSPH_UPD_DT	=	$value["RSPH_UPD_DT"];
		  	}
		  }
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","UPDATE_SITE_M_RESP_HEAD", $params);
	...
	public function delete($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	//$_exist_data = $_fetch_edit["result"];
			...
			$_P_RSPH_ST_SYS_ID = $this->request->getVar("passing_parameter");
			$_P_RSPH_CODE = $this->request->getVar("passing_parameter");
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","DELETE_SITE_M_RESP_HEAD", $params);
