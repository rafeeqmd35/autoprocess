	...
	function __construct()
  {
	...
	public function index(){
		try{
			...
			$sql = " SELECT SH_SYS_ID, SH_ST_SYS_ID, SH_DESC, SH_ROW_NO, SH_IMAGE_PATH, SH_ORDERING, SH_FROM_DT, SH_UPTO_DT, SH_ACTIVE_YN, SH_LANG_CODE, SH_CR_UID, SH_CR_DT, SH_UPD_UID, SH_UPD_DT FROM SITE_M_HEADER  
			...
			if($query){
				...
				foreach ($query as $key => $value) {
					$name_array = [
						...
						"@user_end_parameter_SH_SYS_ID"	=>	$value["SH_SYS_ID"],
						"@user_end_parameter_SH_ST_SYS_ID"	=>	$value["SH_ST_SYS_ID"],
						"@user_end_parameter_SH_DESC"	=>	$value["SH_DESC"],
						"@user_end_parameter_SH_ROW_NO"	=>	$value["SH_ROW_NO"],
						"@user_end_parameter_SH_IMAGE_PATH"	=>	$value["SH_IMAGE_PATH"],
						"@user_end_parameter_SH_ORDERING"	=>	$value["SH_ORDERING"],
						"@user_end_parameter_SH_FROM_DT"	=>	$value["SH_FROM_DT"],
						"@user_end_parameter_SH_UPTO_DT"	=>	$value["SH_UPTO_DT"],
						"@user_end_parameter_SH_ACTIVE_YN"	=>	$value["SH_ACTIVE_YN"],
						"@user_end_parameter_SH_LANG_CODE"	=>	$value["SH_LANG_CODE"],
						"@user_end_parameter_SH_CR_UID"	=>	$value["SH_CR_UID"],
						"@user_end_parameter_SH_CR_DT"	=>	$value["SH_CR_DT"],
						"@user_end_parameter_SH_UPD_UID"	=>	$value["SH_UPD_UID"],
						"@user_end_parameter_SH_UPD_DT"	=>	$value["SH_UPD_DT"],
					];
	...
	public function create(){
		try{
			...
			$_P_SH_ST_SYS_ID = $this->request->getVar("@user_end_parameter_SH_ST_SYS_ID");
			$_P_SH_DESC = $this->request->getVar("@user_end_parameter_SH_DESC");
			$_P_SH_ROW_NO = $this->request->getVar("@user_end_parameter_SH_ROW_NO");
			$_P_SH_IMAGE_PATH = $this->request->getVar("@user_end_parameter_SH_IMAGE_PATH");
			$_P_SH_ORDERING = $this->request->getVar("@user_end_parameter_SH_ORDERING");
			$_P_SH_FROM_DT = $this->request->getVar("@user_end_parameter_SH_FROM_DT");
			$_P_SH_UPTO_DT = $this->request->getVar("@user_end_parameter_SH_UPTO_DT");
			$_P_SH_ACTIVE_YN = $this->request->getVar("@user_end_parameter_SH_ACTIVE_YN");
			...
			$params = array(
				...
				array("name"=>":P_SH_ST_SYS_ID", "value"=>$_P_SH_ST_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SH_DESC", "value"=>$_P_SH_DESC, "type"=>SQLT_CHR, "length"=>250),
				array("name"=>":P_SH_ROW_NO", "value"=>$_P_SH_ROW_NO, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SH_IMAGE_PATH", "value"=>$_P_SH_IMAGE_PATH, "type"=>SQLT_CHR, "length"=>250),
				array("name"=>":P_SH_ORDERING", "value"=>$_P_SH_ORDERING, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SH_FROM_DT", "value"=>$_P_SH_FROM_DT, "type"=>SQLT_CHR, "length"=>300),
				array("name"=>":P_SH_UPTO_DT", "value"=>$_P_SH_UPTO_DT, "type"=>SQLT_CHR, "length"=>300),
				array("name"=>":P_SH_ACTIVE_YN", "value"=>$_P_SH_ACTIVE_YN, "type"=>SQLT_CHR, "length"=>1),
			...
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","INSERT_SITE_M_HEADER", $params);
	...
	public function new(){
		try{
			...
			$sql = " SELECT SH_SYS_ID, SH_ST_SYS_ID, SH_DESC, SH_ROW_NO, SH_IMAGE_PATH, SH_ORDERING, SH_FROM_DT, SH_UPTO_DT, SH_ACTIVE_YN, SH_LANG_CODE, SH_CR_UID, SH_CR_DT, SH_UPD_UID, SH_UPD_DT FROM SITE_M_HEADER  
							WHERE :CR_DT:  = (SELECT MAX(:CR_DT:) FROM SITE_M_HEADER)";
	...
	public function update($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	foreach ($_exist_data as $key => $value) {
					...
					$_OLD_SH_SYS_ID	=	$value["SH_SYS_ID"];
					$_OLD_SH_ST_SYS_ID	=	$value["SH_ST_SYS_ID"];
					$_OLD_SH_DESC	=	$value["SH_DESC"];
					$_OLD_SH_ROW_NO	=	$value["SH_ROW_NO"];
					$_OLD_SH_IMAGE_PATH	=	$value["SH_IMAGE_PATH"];
					$_OLD_SH_ORDERING	=	$value["SH_ORDERING"];
					$_OLD_SH_FROM_DT	=	$value["SH_FROM_DT"];
					$_OLD_SH_UPTO_DT	=	$value["SH_UPTO_DT"];
					$_OLD_SH_ACTIVE_YN	=	$value["SH_ACTIVE_YN"];
					$_OLD_SH_LANG_CODE	=	$value["SH_LANG_CODE"];
					$_OLD_SH_CR_UID	=	$value["SH_CR_UID"];
					$_OLD_SH_CR_DT	=	$value["SH_CR_DT"];
					$_OLD_SH_UPD_UID	=	$value["SH_UPD_UID"];
					$_OLD_SH_UPD_DT	=	$value["SH_UPD_DT"];
		  	}
		  }
		  
			$_P_SH_SYS_ID = $this->request->getVar("@user_end_parameter_SH_SYS_ID");
			$_P_SH_ST_SYS_ID = $this->request->getVar("@user_end_parameter_SH_ST_SYS_ID");
			$_P_SH_DESC = $this->request->getVar("@user_end_parameter_SH_DESC");
			$_P_SH_ROW_NO = $this->request->getVar("@user_end_parameter_SH_ROW_NO");
			$_P_SH_IMAGE_PATH = $this->request->getVar("@user_end_parameter_SH_IMAGE_PATH");
			...
			$params = array(
				...
				array("name"=>":P_SH_SYS_ID", "value"=>$_P_SH_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SH_ST_SYS_ID", "value"=>$_P_SH_ST_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SH_DESC", "value"=>$_P_SH_DESC, "type"=>SQLT_CHR, "length"=>250),
				array("name"=>":P_SH_ROW_NO", "value"=>$_P_SH_ROW_NO, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SH_IMAGE_PATH", "value"=>$_P_SH_IMAGE_PATH, "type"=>SQLT_CHR, "length"=>250),
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","UPDATE_SITE_M_HEADER", $params);
	...
	public function delete($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	//$_exist_data = $_fetch_edit["result"];
			...
			$_P_SH_SYS_ID = $this->request->getVar("passing_parameter");
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","DELETE_SITE_M_HEADER", $params);
