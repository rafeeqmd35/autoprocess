	...
	function __construct()
  {
	...
	public function index(){
		try{
			...
			$sql = " SELECT SF_SYS_ID, SF_ST_SYS_ID, SF_DESC, SF_PARENT_YN, SF_SF_SYS_ID, SF_IMAGE_PATH, SF_ORDERING, SF_FROM_DT, SF_UPTO_DT, SF_ACTIVE_YN, SF_LANG_CODE, SF_CR_UID, SF_CR_DT, SF_UPD_UID, SF_UPD_DT FROM SITE_M_FOOTER  
			...
			if($query){
				...
				foreach ($query as $key => $value) {
					$name_array = [
						...
						"@user_end_parameter_SF_SYS_ID"	=>	$value["SF_SYS_ID"],
						"@user_end_parameter_SF_ST_SYS_ID"	=>	$value["SF_ST_SYS_ID"],
						"@user_end_parameter_SF_DESC"	=>	$value["SF_DESC"],
						"@user_end_parameter_SF_PARENT_YN"	=>	$value["SF_PARENT_YN"],
						"@user_end_parameter_SF_SF_SYS_ID"	=>	$value["SF_SF_SYS_ID"],
						"@user_end_parameter_SF_IMAGE_PATH"	=>	$value["SF_IMAGE_PATH"],
						"@user_end_parameter_SF_ORDERING"	=>	$value["SF_ORDERING"],
						"@user_end_parameter_SF_FROM_DT"	=>	$value["SF_FROM_DT"],
						"@user_end_parameter_SF_UPTO_DT"	=>	$value["SF_UPTO_DT"],
						"@user_end_parameter_SF_ACTIVE_YN"	=>	$value["SF_ACTIVE_YN"],
						"@user_end_parameter_SF_LANG_CODE"	=>	$value["SF_LANG_CODE"],
						"@user_end_parameter_SF_CR_UID"	=>	$value["SF_CR_UID"],
						"@user_end_parameter_SF_CR_DT"	=>	$value["SF_CR_DT"],
						"@user_end_parameter_SF_UPD_UID"	=>	$value["SF_UPD_UID"],
						"@user_end_parameter_SF_UPD_DT"	=>	$value["SF_UPD_DT"],
					];
	...
	public function create(){
		try{
			...
			$_P_SF_ST_SYS_ID = $this->request->getVar("@user_end_parameter_SF_ST_SYS_ID");
			$_P_SF_DESC = $this->request->getVar("@user_end_parameter_SF_DESC");
			$_P_SF_PARENT_YN = $this->request->getVar("@user_end_parameter_SF_PARENT_YN");
			$_P_SF_SF_SYS_ID = $this->request->getVar("@user_end_parameter_SF_SF_SYS_ID");
			$_P_SF_IMAGE_PATH = $this->request->getVar("@user_end_parameter_SF_IMAGE_PATH");
			$_P_SF_ORDERING = $this->request->getVar("@user_end_parameter_SF_ORDERING");
			$_P_SF_FROM_DT = $this->request->getVar("@user_end_parameter_SF_FROM_DT");
			$_P_SF_UPTO_DT = $this->request->getVar("@user_end_parameter_SF_UPTO_DT");
			$_P_SF_ACTIVE_YN = $this->request->getVar("@user_end_parameter_SF_ACTIVE_YN");
			...
			$params = array(
				...
				array("name"=>":P_SF_ST_SYS_ID", "value"=>$_P_SF_ST_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SF_DESC", "value"=>$_P_SF_DESC, "type"=>SQLT_CHR, "length"=>250),
				array("name"=>":P_SF_PARENT_YN", "value"=>$_P_SF_PARENT_YN, "type"=>SQLT_CHR, "length"=>1),
				array("name"=>":P_SF_SF_SYS_ID", "value"=>$_P_SF_SF_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SF_IMAGE_PATH", "value"=>$_P_SF_IMAGE_PATH, "type"=>SQLT_CHR, "length"=>250),
				array("name"=>":P_SF_ORDERING", "value"=>$_P_SF_ORDERING, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SF_FROM_DT", "value"=>$_P_SF_FROM_DT, "type"=>SQLT_CHR, "length"=>300),
				array("name"=>":P_SF_UPTO_DT", "value"=>$_P_SF_UPTO_DT, "type"=>SQLT_CHR, "length"=>300),
				array("name"=>":P_SF_ACTIVE_YN", "value"=>$_P_SF_ACTIVE_YN, "type"=>SQLT_CHR, "length"=>1),
			...
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","INSERT_SITE_M_FOOTER", $params);
	...
	public function new(){
		try{
			...
			$sql = " SELECT SF_SYS_ID, SF_ST_SYS_ID, SF_DESC, SF_PARENT_YN, SF_SF_SYS_ID, SF_IMAGE_PATH, SF_ORDERING, SF_FROM_DT, SF_UPTO_DT, SF_ACTIVE_YN, SF_LANG_CODE, SF_CR_UID, SF_CR_DT, SF_UPD_UID, SF_UPD_DT FROM SITE_M_FOOTER  
							WHERE :CR_DT:  = (SELECT MAX(:CR_DT:) FROM SITE_M_FOOTER)";
	...
	public function update($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	foreach ($_exist_data as $key => $value) {
					...
					$_OLD_SF_SYS_ID	=	$value["SF_SYS_ID"];
					$_OLD_SF_ST_SYS_ID	=	$value["SF_ST_SYS_ID"];
					$_OLD_SF_DESC	=	$value["SF_DESC"];
					$_OLD_SF_PARENT_YN	=	$value["SF_PARENT_YN"];
					$_OLD_SF_SF_SYS_ID	=	$value["SF_SF_SYS_ID"];
					$_OLD_SF_IMAGE_PATH	=	$value["SF_IMAGE_PATH"];
					$_OLD_SF_ORDERING	=	$value["SF_ORDERING"];
					$_OLD_SF_FROM_DT	=	$value["SF_FROM_DT"];
					$_OLD_SF_UPTO_DT	=	$value["SF_UPTO_DT"];
					$_OLD_SF_ACTIVE_YN	=	$value["SF_ACTIVE_YN"];
					$_OLD_SF_LANG_CODE	=	$value["SF_LANG_CODE"];
					$_OLD_SF_CR_UID	=	$value["SF_CR_UID"];
					$_OLD_SF_CR_DT	=	$value["SF_CR_DT"];
					$_OLD_SF_UPD_UID	=	$value["SF_UPD_UID"];
					$_OLD_SF_UPD_DT	=	$value["SF_UPD_DT"];
		  	}
		  }
		  
			$_P_SF_SYS_ID = $this->request->getVar("@user_end_parameter_SF_SYS_ID");
			$_P_SF_ST_SYS_ID = $this->request->getVar("@user_end_parameter_SF_ST_SYS_ID");
			$_P_SF_DESC = $this->request->getVar("@user_end_parameter_SF_DESC");
			$_P_SF_PARENT_YN = $this->request->getVar("@user_end_parameter_SF_PARENT_YN");
			$_P_SF_SF_SYS_ID = $this->request->getVar("@user_end_parameter_SF_SF_SYS_ID");
			...
			$params = array(
				...
				array("name"=>":P_SF_SYS_ID", "value"=>$_P_SF_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SF_ST_SYS_ID", "value"=>$_P_SF_ST_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
				array("name"=>":P_SF_DESC", "value"=>$_P_SF_DESC, "type"=>SQLT_CHR, "length"=>250),
				array("name"=>":P_SF_PARENT_YN", "value"=>$_P_SF_PARENT_YN, "type"=>SQLT_CHR, "length"=>1),
				array("name"=>":P_SF_SF_SYS_ID", "value"=>$_P_SF_SF_SYS_ID, "type"=>SQLT_CHR, "length"=>22),
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","UPDATE_SITE_M_FOOTER", $params);
	...
	public function delete($_id = null){
      ...
      if($_fetch_edit["return_status"] != "0" || $_fetch_edit["return_status"] != "Success" && count($_fetch_edit["result"]) == 0){
      	...
      	//$_exist_data = $_fetch_edit["result"];
			...
			$_P_SF_SYS_ID = $this->request->getVar("passing_parameter");
			...
			$this->db->txn_start_now();
			$datatoShow = $this->db->storedProcedure("SPINE_SITE","DELETE_SITE_M_FOOTER", $params);
